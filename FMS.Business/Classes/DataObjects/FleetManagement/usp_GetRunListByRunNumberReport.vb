...
#Region "Get methods"
        Public Shared Function GetRunListingReport() As List(Of DataObjects.usp_GetRunListByRunNumberReport)
            Try
                Dim objRunListing As New List(Of DataObjects.usp_GetRunListByRunNumberReport)
                With New LINQtoSQLClassesDataContext
                    .CommandTimeout = 180
                    objRunListing = (From c In .usp_GetRunListByRunNumberReport(ThisSession.ApplicationID)
