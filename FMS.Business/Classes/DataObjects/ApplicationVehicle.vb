...
#Region "Selectors"
        ...
        Public Shared Function GetAllForUser(userID As Guid) As List(Of ApplicationVehicle)

            With New LINQtoSQLClassesDataContext

                Return (From x In .usp_GetVehiclesForUser(userID) Select New DataObjects.ApplicationVehicle(x)).ToList
        ...
        Public Shared Function GetAll(appplicationID As Guid) As List(Of ApplicationVehicle)
            ...
            With New LINQtoSQLClassesDataContext
                ...
                Return (From x In .ApplicationVehicles
                        Where x.ApplicationID = appplicationID
        ...
        Public Shared Function GetAllToList(appplicationID As Guid) As List(Of ApplicationVehicle)
        ...
        Public Shared Function GetAllWithDrivers(appid As Guid, querydate As Date, userid As Guid) As List(Of ApplicationVehicle)

            querydate = querydate.timezoneToPerth

            Dim vehicles As List(Of DataObjects.ApplicationVehicle) = GetAllForUser(userID:=userid)
