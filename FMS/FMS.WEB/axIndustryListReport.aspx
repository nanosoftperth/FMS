<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="axIndustryListReport.aspx.vb" Inherits="FMS.WEB.axIndustryListReport" %>
         ...
         <script type="text/javascript">
             function btnProcessReport_Click() {
                 if (cbIndustryList.GetText() != '') {
                     ...
                     LoadingPanel.Show();
                     $("#frmContent").attr("src", "axReportContentPage.aspx?Report=IndustryListReport&param=" + paramValue);
                 }
             }
