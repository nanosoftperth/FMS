    ...
    <form id="form1" runat="server">
        ...
        <div class="centreme">
            ...
            <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="4"
                EnableTabScrolling="True" EnableTheming="True" Theme="SoftOrange">
                <TabPages>
                            ...
                            <dx:ContentControl runat="server">
                                <dx:ASPxGridView KeyFieldName="UserId" ID="dgvUsers" runat="server" AutoGenerateColumns="False" DataSourceID="odsUsers" EnableTheming="True" Theme="SoftOrange" Width="629px">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataDateColumn FieldName="LastLoggedInDate" ShowInCustomizationForm="True" VisibleIndex="5">
                                            <PropertiesDateEdit>
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="RoleID" ShowInCustomizationForm="True" VisibleIndex="6" Caption="Role">
                                ...
                                <asp:ObjectDataSource ID="odsRoles" runat="server" SelectMethod="GetAllRolesforApplication" TypeName="FMS.Business.DataObjects.Role">
                                    <SelectParameters>
                                        ...
                                        <DetailRow>
                                            <dx:ASPxGridView ID="dgvRolesUsers" KeyFieldName="UserID" runat="server" AutoGenerateColumns="False" DataSourceID="odsRolesUsers" OnBeforePerformDataSelect="dgvRolesUsers_BeforePerformDataSelect">
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataComboBoxColumn FieldName="RoleID" VisibleIndex="5">
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: top; padding-left: 50px;">
                                            <table>
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px; padding-top: 12px; vertical-align: top;">
