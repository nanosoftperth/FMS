...
Public Class Uniqco_Integrator
    ...
    Public Function GetCurrentDateTest() As Date Implements IUniqco_Integrator.GetCurrentDateTest
        Return Now
    End Function


    Public Function GetMileageForVehicle(VIN_Number As String, userName As String, password As String) As WebServices.VehicleDistanceData Implements IUniqco_Integrator.GetMileageForVehicle
