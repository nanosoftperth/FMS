<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="axServiceSummaryReport.aspx.vb" Inherits="FMS.WEB.axServiceSummaryReport" %>
        ...
        <script src="Content/javascript/jquery-1.10.2.min.js" ></script>
         <script type="text/javascript">
             function btnProcessReport_Click() {
                LoadingPanel.Show();
                $("#frmContent").attr("src", "axReportContentPage.aspx?Report=ServiceSummaryReport");
             }
