...
Namespace ReportGeneration
    Public Class VehicleDumpActivityReportLine
        ...
        Public Property NoofLoads As Integer
        Public Property AvgLoadToDump As TimeSpan
        Public Property AvgDumpToLoad As TimeSpan 
        Public Property AvgLoadTime As TimeSpan
        Public Property AvgDumpTime As TimeSpan
...
#Region "read only properties (mostly for formatting, dev express forms causing issues)"
        ...
        Public ReadOnly Property formatted_EndTime As String
            Get
                If EndTime.HasValue Then
                    Return EndTime.Value.ToString(dateFormat)
                Else
                    Return String.Empty
                End If
            End Get
        ...
        Public ReadOnly Property formatted_StartTime As String
            ...
            End Get
        End Property
        Public ReadOnly Property formatted_NoofLoads As Integer
            Get
                Return NoofLoads  
            End Get
        End Property
        Public ReadOnly Property formatted_AvgLoadToDump As String
                Get
                Return timespanFormatCust(AvgLoadToDump)
            End Get
        End Property
         Public ReadOnly Property formatted_AvgDumpToLoad As String
            Get
                Return timespanFormatCust(AvgDumpToLoad)
            End Get
        End Property
        Public ReadOnly Property formatted_AvgLoadTime As String
            Get
                Return timespanFormatCust(AvgLoadTime)
            End Get
        End Property
        Public ReadOnly Property formatted_AvgDumpTime As String
            Get
                Return timespanFormatCust(AvgDumpTime)
            End Get
        End Property
...
#End Region
        ...
        Friend Shared Function GetFromSpeedTimes(speedTimes As List(Of ActivityReportLine)) As List(Of VehicleDumpActivityReportLine)

            'Dim count As Integer = speedTimes.Count
            Dim retobjs As New List(Of VehicleDumpActivityReportLine)
            Dim loopVARL As New VehicleDumpActivityReportLine

            'Starttime is the "beginning of  travelling"VehicleDumpActivityReportLine
            ...
            For i As Integer = 1 To speedTimes.Count - 2
                ...
                If s_next.ActivityReportType = ActivityReportLineType.Travelling Then
                    ...
                    loopVARL = New VehicleDumpActivityReportLine
            ...
            For Each varl As ReportGeneration.VehicleDumpActivityReportLine In retobjs
