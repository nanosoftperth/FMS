...
Public Class FleetMap2
    ...
    Private Sub FleetMap_Init(sender As Object, e As EventArgs) Handles Me.Init
        ...
        Dim lst As List(Of FMS.Business.DataObjects.ApplicationGeoFence) =
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim appLocationID As Guid = If(FMS.Business.ThisSession.User.ApplicationLocationID = Guid.Empty,
                                       FMS.Business.ThisSession.ApplicationObject.DefaultBusinessLocationID,
    ...
    Private Sub dgvGeoFenceSummary_CustomCallback(sender As Object, e As DevExpress.Web.ASPxGridViewCustomCallbackEventArgs) Handles dgvGeoFenceSummary.CustomCallback
        ...
        dgvGeoFenceSummary.DataSource = FMS.Business.DataObjects.ApplicationGeoFence.
