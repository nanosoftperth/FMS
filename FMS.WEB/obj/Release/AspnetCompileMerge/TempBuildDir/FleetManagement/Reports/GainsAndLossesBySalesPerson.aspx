<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GainsAndLossesBySalesPerson.aspx.vb" Inherits="FMS.WEB.GainsAndLossesBySalesPerson" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function btnProcessReport_Click() {
            LoadingPanel.Show();
            $("#frmContent").attr("src", "../ReportContentPage.aspx?Report=GainsAndLossesBySalesPerson");
        }
