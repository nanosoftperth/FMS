...
<head runat="server">
    ...
    <script>
        ...
        function OnClickYes(s, e) {
            cltContractPreviousSuppliersGridView.DeleteRow(visibleIndex);
            popupDelete.Hide();
        }
...
<body>
    <form id="form1" runat="server">
        <dx:ASPxGridView ID="ContractPreviousSuppliersGridView" KeyFieldName="PreviousSupplierID" 
            DataSourceID="odsContractPreviousSuppliers" runat="server" Theme="SoftOrange" AutoGenerateColumns="False"
            ClientInstanceName="cltContractPreviousSuppliersGridView">
