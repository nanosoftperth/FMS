...
*
*   @work of Dave Gardner - to work with this porject.
*
*   Usage:
*
*   Create the class
...
function cSnapToRoute() {
    ...
    **/
    this.loadRouteData = function () {
        ...
        for (var i = 0; i < this._oPolyline.getPath().length ; i++) {
            var Px = this.normalProj.fromLatLngToPixel(this._oPolyline.getPath(i), zoom);
