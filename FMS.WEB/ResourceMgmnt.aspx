                           ...
                           <dx:ASPxGridView ID="dgvDetailBookings" ClientInstanceName="dgvDetailBookings"
                              ...
                              <Columns>
                                ...
                                <dx:GridViewDataBinaryImageColumn FieldName="DriverPhotoBinary" VisibleIndex="4">
                                 ...
                                 <dx:GridViewDataComboBoxColumn FieldName="ApplicationDriverID" Caption="Driver" ShowInCustomizationForm="True" VisibleIndex="5">
                                 ...
                                 <dx:GridViewDataComboboxColumn FieldName="ContactID" Caption="Customer" ShowInCustomizationForm="True" VisibleIndex="8">
                                 ...
                                 <dx:GridViewDataTextColumn FieldName="CustomerPhone" ShowInCustomizationForm="True" VisibleIndex="9">
                                 </dx:GridViewDataTextColumn>
                                 <dx:GridViewDataTextColumn FieldName="CustomerEmail" ShowInCustomizationForm="True" VisibleIndex="10">
                                 </dx:GridViewDataTextColumn>
                                 <dx:GridViewDataCheckColumn FieldName="IsAlert5min" Caption="Alert if 5 min away" ShowInCustomizationForm="True" VisibleIndex="11">
                                 </dx:GridViewDataCheckColumn>
                                 <dx:GridViewDataCheckColumn FieldName="IsAlertLeaveForPickup" Caption="Alert if has left for pickup" ShowInCustomizationForm="True" VisibleIndex="12">
                                 </dx:GridViewDataCheckColumn>
                              </Columns>
                           </dx:ASPxGridView>
