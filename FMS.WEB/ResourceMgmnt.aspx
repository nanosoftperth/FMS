...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        <tr>
            ...
            <td>
                <dx:ASPxPageControl ID="pageControlMain" runat="server" ActiveTabIndex="0">
                    <TabPages>
                            ...
                            <ContentCollection>
                                <dx:ContentControl runat="server">
                                    ...
                                    <dx:ASPxGridView ID="dgvVehicles"
                                        ...
                                        OnCustomColumnDisplayText="dgvVehicles_CustomColumnDisplayText">
                                                     ...
                                                     <Columns>
                                                        <dx:GridViewCommandColumn ShowSelectCheckbox="true" VisibleIndex="0" Width="1">
                                                            ...
                                                            <HeaderTemplate>
                                                                ...
                                                                OnInit="cbAll_Init">
                                                                    <ClientSideEvents CheckedChanged="OnAllCheckedChangedBussLoc" />
                                                                </dx:ASPxCheckBox>
                                                            </HeaderTemplate>
                                                        </dx:GridViewCommandColumn>
