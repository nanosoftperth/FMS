<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="axServiceListReport.aspx.vb" Inherits="FMS.WEB.axServiceListReport" %>
        ...
        <script src="Content/javascript/jquery-1.10.2.min.js" ></script>
         <script type="text/javascript">
             function btnProcessReport_Click() {
                LoadingPanel.Show();
                $("#frmContent").attr("src", "axReportContentPage.aspx?Report=ServiceListReport");
             }
