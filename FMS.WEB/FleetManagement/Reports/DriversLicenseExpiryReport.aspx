<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DriversLicenseExpiryReport.aspx.vb" Inherits="FMS.WEB.DriversLicenseExpiryReport" %>
        ...
        <script src="../../Content/javascript/jquery-1.10.2.min.js" ></script>
         <script type="text/javascript">
             ...
             function ShowReport() {
                //AdjustWindowHeightAndWidth();
                LoadingPanel.Show();
                $("#frmContent").attr("src", "../ReportContentPage.aspx?Report=DriversLicenseExpiryReport");
             }
