<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ContractCeaseReasonsPopup.aspx.vb" Inherits="FMS.WEB.ContractCeaseReasonsPopup" %>
    ...
    <form id="form1" runat="server">
        <div class="centerBlock">
            <dx:ASPxGridView ID="ContractCeaseReasonsGridView" KeyFieldName="CeaseReasonID" DataSourceID="odsContractCeaseReasons" runat="server" AutoGenerateColumns="False"
                ClientInstanceName="cltContractCeaseReasonsGridView">
