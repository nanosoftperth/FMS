...
Public Class ReportPageValidator
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ' below was commented out as we dont care at this point about the uniqco integartion, just trying to get the report page working.
        AuthenticateToken()
    End Sub
    Private Sub AuthenticateToken()
        ...
        Try
            ...
            'If urlToken.SuccessLogin Or True Then
            If True Then
                Dim company = FMS.Business.ThisSession.ApplicationName 'urlToken.URL.Split("/")(2).Split(".")(0) 'get company name
                ...
                'Response.Redirect(urlToken.URL.Replace("uniqco.nanosoft.com.au", "localhost:18356").Replace("FleetMap.aspx", "DataLoggerReport.aspx").Replace("VinNumber={0}&", ""), False)
                Response.Redirect("~/DataLoggerReport.aspx", False)
                'Response.Redirect(urlToken.URL.Replace("FleetMap.aspx", "DataLoggerReport.aspx").Replace("VinNumber={0}&", ""), False)
            Else
                FMS.Business.ThisSession.ProblemPageMessage = "unexpected error, sould not have failed authentication as was set to pass by default, error code 33726524"
